## beethoven-piano-sonata Makefile
##
## Programmer:    Craig Stuart Sapp <craig@ccrma.stanford.edu>
## Creation Date: Tue Jun  3 16:21:12 PDT 2014
## Last Modified: Tue Jun  3 16:21:16 PDT 2014
## Filename:      Makefile
## Syntax:        GNU/BSD makefile
##
## Description:   Makefile for basic processing Humdrum data files 
##                for the piano sonatas of Ludwig van Beethoven.
##
...
#           git clone https://github.com/craigsapp/beethoven-piano-sonatas
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://beethoven/sonatas)
	@echo "[0;32m"
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/craigsapp/beethoven-piano-sonatas[0;31m"
	@echo "[0m"
	exit 1
endif
